...
public final class MediaStore {
  ...
  private static final String BASE_SQL_FIELDS = MediaColumns._ID + " INTEGER PRIMARY KEY," + //
      ...
      MediaColumns.AVAILABLE_SIZE + " INTEGER static.js.plugin.xheditor.xheditor_emot.default 0," + //
  ...
  public static final class Video {
    ...
    public static final class Media implements VideoColumns {
      ...
      protected static final String SQL_FIELDS = BASE_SQL_FIELDS + //
          ...
          HIDDEN + " INTEGER static.js.plugin.xheditor.xheditor_emot.default 0," + // 1 hidden , 0 visible
          SUBTRACK + " TEXT," + //
          AUDIO_TRACK + " INTEGER";
