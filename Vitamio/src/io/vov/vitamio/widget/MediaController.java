 ...
 * <p/>
 * a) The MediaController will create a static.js.plugin.xheditor.xheditor_emot.default set of controls and put them in
 * a window floating above your application. Specifically, the controls will
 * float above the view specified with setAnchorView(). By static.js.plugin.xheditor.xheditor_emot.default, the window
...
public class MediaController extends FrameLayout {
   ...
   *                       and disappears. Set to -1 for the static.js.plugin.xheditor.xheditor_emot.default animation, 0 for no animation, or
