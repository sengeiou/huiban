...
public class MediaPlayer {
   ...
   * permission. By static.js.plugin.xheditor.xheditor_emot.default, no attempt is made to keep the device awake during
   * playback.
   *
  ...
  public native void setCacheDirectory(String directory);
	...
	/**
   * Adaptive streaming support, static.js.plugin.xheditor.xheditor_emot.default is false
   *
  ...
  /**
   * Use static.js.plugin.xheditor.xheditor_emot.default chartset {@link #getTrackInfo()} method.
   *
   ...
   * </p>
   * <p>
   * The first audio and video tracks are selected by static.js.plugin.xheditor.xheditor_emot.default if available, even
   ...
   * VIDEOQUALITY_LOW, static.js.plugin.xheditor.xheditor_emot.default is VIDEOQUALITY_LOW.
   *
   * @param quality <ul>
  ...
  /**
   * Set the Video Chroma quality when play video, static.js.plugin.xheditor.xheditor_emot.default is VIDEOCHROMA_RGB565
  ...
  /**
   * The buffer to fill before playback, static.js.plugin.xheditor.xheditor_emot.default is 1024*1024 Byte
   *
   ...
   *
   * @param speed e.g. 0.8 or 2.0, static.js.plugin.xheditor.xheditor_emot.default to 1.0, range in [0.5-2]
   */
