...
function item(data) {
    ...
    // window.android.loadData(0,res4[0].type) 
    // firstone(data)
    var ul = document.getElementsByClassName("ul")[0];
    var str1 = "";
...
function rende2(data) {
    if (data[0].optionName == "subjective") {
        ...
        var answerimg = document.getElementsByClassName("answerimg")[0];
        ...
        function camera(data) {
            ...
            document.getElementsByClassName("camera")[0].onclick = function () {
                ...
                // window.android.startAnswerPage(1,0);
                // 返回一个src
                subproblem(date, index,type)
            }
        }
        // 调取本地图片
        camera(data)
        ...
        function drawing(data) {
            document.getElementsByClassName("drawing")[0].onclick = function () {
                trans.style.display = "none";
                answer.style.display = 'block';
                // window.android.startAnswerPage(2,0);
                console.log("111")
                // 返回一个src;
                subproblem(date, index,type)
            }
        ...
        function words(data) {
            document.getElementsByClassName("words")[0].onclick = function () {
                trans.style.display = "none";
                answer.style.display = 'block';
                // window.android.startAnswerPage(3,0);
                console.log("111")
                // 返回一个src;
                subproblem(date, index,type)
            }
...
function rende(data, index) {
    ...
    if (data[index].optionName == "subjective") {
        ...
        var imgtype = document.querySelectorAll('[img-type="tex"]');
        var answerimg = document.getElementsByClassName("answerimg")[0];
        var text = document.getElementsByClassName("picture")[0];
        for (var i = 0; i < imgtype.length; i++) {
            imgtype[i].style.height = '0.4rem';
        }
        // 相机
        function camera(data) {
            ...
            document.getElementsByClassName("camera")[0].onclick = function () {
                ...
                // window.android.startAnswerPage(1,index);
        ...
        function drawing(data) {
            document.getElementsByClassName("drawing")[0].onclick = function () {
                trans.style.display = "none";
                answer.style.display = 'block';
                // window.android.startAnswerPage(2,index);
                // 返回一个src;
        ...
        function words(data) {
            document.getElementsByClassName("words")[0].onclick = function () {
                trans.style.display = "none";
                answer.style.display = 'block';
                // window.android.startAnswerPage(3,index);
                // 返回一个src;
        ...
        // 调取写字
        words(data)
        function subproblem(date,index,type) {
            var num = parseInt(index);
            data[num].stuAnswer = date;
            if(type == "1" || type == "2"){
            answerimg.src = date;
        } else {
...
answerlist.onclick = function () {
    ...
    for (var i = 0; i < room.length; i++) {
        if (room[i] != undefined) {
            console.log(typeof (JSON.stringify(room[i])))
